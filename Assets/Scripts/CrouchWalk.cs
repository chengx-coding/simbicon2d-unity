    ...
    void Start()
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            if (i == 0 || i == 2)
            {
                ...
                state[i].torso = -0.2f;
                state[i].swingHip = 1.10f;
                state[i].swingKnee = -2.17f;
                state[i].swingAnkle = 0.62f;
                state[i].stanceKnee = -0.97f;
                state[i].stanceAnkle = 0.44f;
            }
            else
            {
                ...
                state[i].stanceKnee = -0.92f;
                state[i].stanceAnkle = 0.44f; //0.2f
            }
            state[i].Init();
        }
